...
Obj_Jogo.add_game("TLG","Solo e Aventurado","23/08/2015","12+",130,1)
Obj_Dev.add_dev("genDESIGN")
Obj_Plata.add_plata("PS2", "SIC")
Obj_Gen.add_gen("Aventura e Ação")
...
# Obj_Jogo.update_game(2, "Fumito Ueda", "Uma pessoa foda", "1997", "45", 10, 1)
# Obj_Dev.update_dev(2, "Nomad")
# Obj_Plata.update_plata(2, "IBM-6070", "IBM")
# Obj_Gen.update_gen(2, "Pessoa")
